...
const VALUE_PROPS = [
  '✓ 500+ PM-scored ideas',
  '✓ Market-validated gaps',
  '✓ SpecFlow-ready specs',
]
...
function SignupForm() {
  ...
  const loginHref = `/auth/login${next !== '/hub/browse' ? `?next=${encodeURIComponent(next)}` : ''}`
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: '0.9375rem', color: 'var(--muted)', margin: '0 0 28px 0' }}>
          Start discovering validated product ideas.
        </p>
        ...
        {otpSent ? (
          <div style={{ textAlign: 'center', padding: '8px 0' }}>
            ...
            {otpError && <div style={{ ...errorStyle, marginTop: 12 }}>{otpError}</div>}
          </div>
        ) : (
          <>
            {/* Google button */}
            ...
            {googleError && <div style={{ ...errorStyle, marginTop: 8 }}>{googleError}</div>}
            ...
            <form onSubmit={handleOtp}>
              ...
              {otpError && <div style={{ ...errorStyle, marginTop: 8 }}>{mapOtpError(otpError)}</div>}
            </form>
          </>
        )}
        ...
        <p style={{
          ...
          <Link href={loginHref} style={{ color: '#e4611a', textDecoration: 'none', fontWeight: 500 }}>
            Sign in →
          </Link>
        </p>
      </div>
