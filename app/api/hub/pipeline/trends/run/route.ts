...
import { runWeeklyTrendsPipeline } from '@/app/lib/ai/pipelines/runWeeklyTrendsPipeline'

export const dynamic = 'force-dynamic'

// Intended: Monday 06:00 UTC
export async function POST(request: Request) {
  ...
  after(() => runWeeklyTrendsPipeline(runId, weekStart).catch((e) => console.error('[trends/run]', e)))
